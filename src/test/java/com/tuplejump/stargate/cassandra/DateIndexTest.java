...
public class DateIndexTest extends IndexTestBase {
    ...
    public void shouldWorkForDateColumn() throws Exception {
        try {
            ...
            String query = "SELECT stargate FROM event_store WHERE stargate = '{ function:{ type:\"aggregate\", aggregates:[{type:\"count\",field:\"event_id\"}], groupBy:[\"return DateUtils.getTimeByGranularity(event_ts,600000)\"],imports:[\"com.tuplejump.stargate\"]  }}' ;";

...
public class UpdateAndQueryTest extends IndexTestBase {
    ...
    private void createTableAndIndex() {
        ...
        Record r1 = new Record(fields, fieldTypes, new Object[]{1, false, 29, "green", "Davidson Hurst", "male", "TALKOLA", "davidsonhurst@talkola.com", "+1 (950) 405-2257", "691 Hampton Place, Felt, North Carolina, 8466"});
        Record r2 = new Record(fields, fieldTypes, new Object[]{2, false, 27, "black", "Maxwell Kemp", "male", "AMTAP", "maxwellkemp@amtap.com", "+1 (800) 495-3822", "466 Kenilworth Place, Fivepointville, Maryland, 6240"});
        Record r3 = new Record(fields, fieldTypes, new Object[]{3, false, 25, "black", "Cecelia Cain", "female", "MAINELAND", "ceceliacain@maineland.com", "+1 (874) 590-2058", "644 Broome Street, Rutherford, Delaware, 6271"});
        Record r4 = new Record(fields, fieldTypes, new Object[]{4, true, 28, "green", "Morse Sanders", "male", "APEX", "morsesanders@apex.com", "+1 (857) 427-3391", "786 Division Avenue, Rose, Rhode Island, 4217"});
        Record r5 = new Record(fields, fieldTypes, new Object[]{5, true, 25, "black", "Fernandez Morse", "male", "OPTICALL", "fernandezmorse@opticall.com", "+1 (911) 442-2649", "116 Suydam Place, Libertytown, Michigan, 2257"});
        Record r6 = new Record(fields, fieldTypes, new Object[]{6, false, 27, "brown", "Ryan Ross", "male", "ZAPHIRE", "ryanross@zaphire.com", "+1 (843) 423-2420", "804 Erskine Loop, Robinette, Marshall Islands, 9161"});
        Record r7 = new Record(fields, fieldTypes, new Object[]{7, true, 34, "brown", "Avis Mosley", "female", "TETRATREX", "avismosley@tetratrex.com", "+1 (883) 461-3832", "391 Heyward Street, Hayes, Alabama, 5934"});
        Record r8 = new Record(fields, fieldTypes, new Object[]{8, false, 29, "black", "Juana Ewing", "female", "REPETWIRE", "juanaewing@repetwire.com", "+1 (809) 410-2791", "510 Lake Avenue, Austinburg, Virgin Islands, 2964"});
        Record r9 = new Record(fields, fieldTypes, new Object[]{9, false, 33, "brown", "Edwards Patton", "male", "MANGELICA", "edwardspatton@mangelica.com", "+1 (977) 508-2935", "131 Stone Avenue, Cucumber, Minnesota, 4601"});
        Record r10 = new Record(fields, fieldTypes, new Object[]{10, false, 38, "blue", "Weaver Carson", "male", "ISOLOGIX", "weavercarson@isologix.com", "+1 (916) 566-2681", "560 Hanson Place, Gardners, Puerto Rico, 7821"});
